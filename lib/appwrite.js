...
export const getLiked = async (userId) => {
    try {
        ...
        console.log(likedPosts.documents.videoId)
        return likedPosts.documents.videoId;
    } catch (error) {
        throw new Error(error);
    }
}

// export const likeVideo = async (userId, video, like) => {
//     try {
//         // Fetch the current document
        
//         const listDocs = await databases.listDocuments(
//             databaseId,
//             videoCollectionId,
//             [Query.equal('video', [video])]
//         );

//         const currentDocument = listDocs.documents[0]

//         // Get the current liked array and append the new userId
//         const likedIds = currentDocument.likedIds || [];
...
export const likeVideo = async (userId, videoId, like) => {
    try {
        ...
        if(like){
            ...
            //left off here, this function makes it to where duplicate like docs can be made
